...
<a id="index"></a>
- 01:00~05:59	raw: [2025版管理excel](#20241226010000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2024.12.26.[2025版管理excel]任务&body=日期: 2024.12.26.%0D%0A序号: 6%0D%0A手稿:../../draft/2024/12/20241225.a.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20241226010000"></a>
## 01:00 ~ 05:59
# 01:00~01:45
2025版管理excel
...
- 保留几个直观方便的排期表在excel。
  ...
  - 2025衣
- 资源账目转到代码处理。
  - 时间、货币等资源以yaml记录，使用复式记账分录；
  - 账本科目由ego管理，使用task、protocol、entity等定义；
