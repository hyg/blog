...
<a id="index"></a>
- 17:36~18:35	check: [零散笔记](#20251123173600)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2025.11.23.[无名任务]任务&body=日期: 2025.11.23.%0D%0A序号: 5%0D%0A手稿:../../draft/2025/20251123.01.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20251123173600"></a>
## 17:36 ~ 18:35
## check: [零散笔记]

- bylaw-analyzer MCP server在goose没有运行起来。
```
➜  qwen git:(master) ✗ cat mcp_log_2025-11-23T13-35-07-494Z.txt 
[2025-11-23T13:35:07.496Z] PSMD.MCP (MCP-compliant version with vscode-jsonrpc) started. Ready to receive JSON-RPC requests.
[2025-11-23T13:35:31.862Z] JSON-RPC Connection Closed.
```
