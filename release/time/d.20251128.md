...
<a id="index"></a>
- 19:27~20:26	check: [零散笔记](#20251128192700)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2025.11.28.[无名任务]任务&body=日期: 2025.11.28.%0D%0A序号: 5%0D%0A手稿:../../draft/2025/20251128.01.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20251128192700"></a>
## 19:27 ~ 20:26
## check: [零散笔记]

- 再整理email、IM、restful接口的功能分配，自然语言和元数据的组合。
