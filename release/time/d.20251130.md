...
<a id="index"></a>
- 18:43~19:42	check: [零散笔记](#20251130184300)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2025.11.30.[无名任务]任务&body=日期: 2025.11.30.%0D%0A序号: 5%0D%0A手稿:../../draft/2025/20251130.01.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20251130184300"></a>
## 18:43 ~ 19:42
## check: [零散笔记]

- https://pages.edgeone.ai
	- 创建账号并部署blog repo试用。
	- blogrepo.edgeone.cool
- https://cnb.cool/
	- 腾讯有钱有野心，但AI应用的基础设施和互联网时代不同，需要对思考过程的分析解构，继续观察。
- 准备新版ego和PSMD。
