...
<a id="index"></a>
- 19:00~19:59	check: [零散笔记](#20251215190000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2025.12.15.[无名任务]任务&body=日期: 2025.12.15.%0D%0A序号: 11%0D%0A手稿:../../draft/2025/20251215.04.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20251215190000"></a>
## 19:00 ~ 19:59
## check: [零散笔记]

- jsonlogic适合处理数学公式，不适合规章和合同。
- 把SOP engine接口升级为protocol engine，作为free manifest 到 code manifest的接口。
