...
<a id="index"></a>
- 19:00~19:59	check: [零散笔记](#20260114190000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2026.01.14.[无名任务]任务&body=日期: 2026.01.14.%0D%0A序号: 11%0D%0A手稿:../../draft/2026/20260114.04.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20260114190000"></a>
## 19:00 ~ 19:59
## check: [零散笔记]

- OTP：两端共享密钥加上移动因子，取哈希缩短作为一次性密码。移动因子有时间和计数器两大类。
- 去中心化通信时，可以用OTP作为密码、房间号、邮箱号来屏蔽饱和攻击。
- model provider的API仍在激烈变化，人机协同的模式要保留足够的前瞻性。
