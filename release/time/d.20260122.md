...
<a id="index"></a>
- 19:00~19:59	check: [零散笔记](#20260122190000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2026.01.22.[无名任务]任务&body=日期: 2026.01.22.%0D%0A序号: 11%0D%0A手稿:../../draft/2026/20260122.04.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20260122190000"></a>
## 19:00 ~ 19:59
## check: [零散笔记]

- PSMD设计专门的共同体建模语言、培养部署者和建模者；infra提供部署容器。
- ego设计主体建模语言，兼容共同体建模语言，并且维护俱乐部模型。
	- 拓展到叠加态，解决缸中之脑悖论的中间结果可以支撑上述主体运行，要求热插拔。
