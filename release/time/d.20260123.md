...
<a id="index"></a>
- 19:00~19:59	check: [零散笔记](#20260123190000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2026.01.23.[无名任务]任务&body=日期: 2026.01.23.%0D%0A序号: 11%0D%0A手稿:../../draft/2026/20260123.04.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20260123190000"></a>
## 19:00 ~ 19:59
## check: [零散笔记]

- git worktree
	- https://git-scm.cn/docs/git-worktree
- 先集中做boot，然后做议事，最后是决议engine。
	- 前期在内部使用model engine：COM、SOP。
