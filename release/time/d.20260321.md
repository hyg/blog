...
<a id="index"></a>
- 19:00~19:59	check: [零散笔记](#20260321190000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2026.03.21.[无名任务]任务&body=日期: 2026.03.21.%0D%0A序号: 7%0D%0A手稿:../../draft/2026/20260321.02.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20260321190000"></a>
## 19:00 ~ 19:59
## check: [零散笔记]

- codebuddy默认整个分区是工作区，有的写和删不询问。
- SOP engine的抽象接口
