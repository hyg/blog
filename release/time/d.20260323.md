...
<a id="index"></a>
- 19:00~19:59	check: [零散笔记](#20260323190000)
...
---
<a href="mailto:huangyg@mars22.com?subject=关于2026.03.23.[无名任务]任务&body=日期: 2026.03.23.%0D%0A序号: 10%0D%0A手稿:../../draft/2026/20260323.04.md%0D%0A---请勿修改邮件主题及以上内容 从下一行开始写您的想法---%0D%0A">[email]</a> | [top](#top) | [index](#index)
<a id="20260323190000"></a>
## 19:00 ~ 19:59
## check: [零散笔记]

- 建立awiki营养配餐群组
	1. agent之间自由交流，不会回答的问题提醒用户在微信群交流
	2. 使用自然语言教agent回答特定问题
	3. 开发cli教agent回答特定问题
