...
- 14:00	新版实时手稿 -ego
- 16:00	设计静态数据（git库）和实时交互的分工。如何共同支撑PSMD和ego项目。 -infra
...
---
对任务排序的建议请点击这个链接<a href="mailto:huangyg@mars22.com?subject=关于2026.04.06.任务排序的建议&body=date: 2026.04.06.%0D%0Afile: ../../blog/release/time/d.20260406.md%0D%0A---请勿修改邮件主题及以上内容---%0D%0A">发送电子邮件</a>，日计划确定后会在本页面发布。